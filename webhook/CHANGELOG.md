...
### Added
- Allowlist `.zip` so archive uploads (e.g. Zoom recording bundles) trigger the worker instead of being silently skipped. The worker handles unpacking and per-entry transcription.
