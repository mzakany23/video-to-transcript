...
from ...core.exceptions import AuthenticationError, TranscriptionError
...
from ...core.resilience import circuit_breaker, retry_on_error, timeout
...
class OpenAITranscriptionProvider(TranscriptionProvider):
    ...
    def _initialize_client(self):
        ...
        try:
            ...
            raise TranscriptionError("OpenAI package not installed. Run: pip install openai")
    ...
    async def transcribe(
        self, audio_path: str, options: Optional[TranscriptionOptions] = None
    ) -> TranscriptionResult:
        """
        ...
        def _transcribe():
            try:
                ...
                result = TranscriptionResult(
                    ...
                    model=api_options.get("model", "whisper-1"),
                    metadata={"file_path": audio_path, "file_size": file_size},
                )
                ...
                if "API" in str(e) or "authentication" in str(e).lower():
                    raise AuthenticationError(f"OpenAI API error: {str(e)}")
