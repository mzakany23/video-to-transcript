...
class TestOrchestrationAPI:
    ...
    def test_detailed_status(
        self, mock_orchestration_dep, mock_factory_dep, orchestration_client, mock_service_factory
    ):
...
class TestBatchAPI:
    ...
    @patch("api.orchestration_api.dependencies.get_orchestration_service")
    def test_submit_batch_jobs(
        self, mock_orchestration_dep, orchestration_client, sample_batch_request
    ):
...
class TestRunnersAPI:
    ...
    def test_validate_runner(self, mock_factory_dep, orchestration_client, mock_service_factory):
        ...
        mock_service_factory.validate_configuration.return_value = {
            "valid": True,
            "provider_status": {"job_runner": {"status": "valid", "name": "local", "error": None}},
        }
    ...
    @patch("api.orchestration_api.dependencies.get_service_factory")
    def test_validate_nonexistent_runner(
        self, mock_factory_dep, orchestration_client, mock_service_factory
    ):
